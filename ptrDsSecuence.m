function ptrDsSecuence (hMainWin)
    ...
    h.buttonsBar.btnLeft = uicontrol('Parent', h.btnPanel, ...
        ...
        'CData', ptrLoadIcon(ptrData.params,'go_left.png',bgColor));
    ...
    h.buttonsBar.btnRight = uicontrol('Parent', h.btnPanel, ...
        ...
        'CData', ptrLoadIcon(ptrData.params,'go_right.png',bgColor));
    ...
    % Play/stop button
    icons = {ptrLoadIcon(ptrData.params,'stop.png',bgColor); ...
             ptrLoadIcon(ptrData.params,'play.png',bgColor)};
    h.buttonsBar.btnLeft = uicontrol('Parent', h.btnPanel, ...
        'Style','togglebutton', ...
        'Units','Pixels', ...
    ...
    icons = {ptrLoadIcon(ptrData.params,'sliceOne.png',bgColor); ...
             ptrLoadIcon(ptrData.params,'sliceAll.png',bgColor)};
    h.buttonsBar.btnLeft = uicontrol('Parent', h.btnPanel, ...
        'Style','togglebutton', ...
        'Units','Pixels', ...
